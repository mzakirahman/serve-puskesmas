        ...
        <div class="block w-full h-auto p-0 mt-4 rounded bg-white text-black/[0.87] shadow-01dp">
          <div class="block w-full h-auto p-0 m-0 overflow-hidden">
            <div class="flex justify-between items-center w-full h-16 p-2 m-0 relative">
              ...
              <div class="inline-block w-auto h-auto p-0 m-0 relative">
                <a class="block w-10 h-10 p-2 m-0 text-black/[0.60] rounded-full align-middle cursor-pointer outline-none transition duration-150 ease-in-out hover:bg-black/[0.04] active:bg-black/[0.10] focus:bg-black/[0.12]" href="{{ route('doctors.create') }}" data-te-toggle="tooltip" title="Create" data-te-ripple-init data-te-ripple-color="light" aria-label="Create">
                  <svg 
                    class="pointer-events-none w-6 h-6 fill-current"
                    xmlns="http://www.w3.org/2000/svg" 
                    height="24px" 
              ...
              <tbody class="table-row-group">
                @forelse ($doctors as $doctor)
                  <tr class="table-row w-full h-auto p-0 m-0 align-middle text-inherit bg-white outline-none hover:bg-black/[0.04]">
                    ...
                    <td class="table-cell h-[52px] px-4 m-0 border-b border-solid border-black/[0.12] body-2 text-black/[0.87] text-left select-auto whitespace-nowrap relative">
                      @if ($doctor->active)
                        <span class="inline-block w-auto h-6 px-2.5 m-0 bg-green-500/[0.04] text-green-500 font-Roboto caption font-medium rounded-full align-middle leading-6 select-none">Active</span>
                      @else
                        <span class="inline-block w-auto h-6 px-2.5 m-0 bg-red-500/[0.04] text-red-500 font-Roboto caption font-medium rounded-full align-middle leading-6 select-none">Not active</span>
                      @endif
                    </td>
                    <td class="table-cell h-[52px] px-4 m-0 border-b border-solid border-black/[0.12] body-2 text-black/[0.87] text-center select-auto whitespace-nowrap relative">
                      <form action="{{ route('doctors.destroy', $doctor->id) }}" method="post">
                        ...
                        <a class="inline-block w-10 h-10 p-2 mx-auto text-black/[0.60] rounded-full align-middle cursor-pointer outline-none transition duration-150 ease-in-out hover:bg-black/[0.04] active:bg-black/[0.10] focus:bg-black/[0.12]" href="{{ route('doctors.edit', $doctor->id) }}" data-te-toggle="tooltip" title="Edit" data-te-ripple-init data-te-ripple-color="light" aria-label="Edit">
                          <svg 
                            class="pointer-events-none w-6 h-6 fill-current" 
                            xmlns="http://www.w3.org/2000/svg" 
                            height="24px"
                ...
                @empty
                  <tr class="table-row w-full h-auto p-0 m-0 align-middle text-inherit bg-white outline-none hover:bg-transparent">
                    <td class="table-cell h-[52px] px-4 m-0 border-b border-solid border-black/[0.12] body-2 text-black/[0.87] text-center select-auto whitespace-nowrap relative" colspan="8">
                      No data.
                    </td>
                  </tr>
                @endforelse
          ...
          <div class="block w-full h-auto p-0 m-0 overflow-x-auto">
            <div class="flex justify-start items-center w-full h-[52px] p-2 m-0 relative">
              {{ $doctors->links('layouts.pagination') }}
            </div>
          </div>
        </div>
      </div>
